...
const handleFile = (files) => {
    ...
    // await emit('sendFile', selectedFile, progressHandler)
...
// Función para icono representativo según tipo
...
<template>
    <div class="flex flex-col items-center justify-center ">
        ...
        <label
            ...
            <!-- Vista previa -->
            <div v-else class="flex flex-col items-center gap-2" :title="file.name+'-'+file.size+' KB'">
                <div
                ...
                <!-- Botón limpiar -->
                <Icon @click="clearFile" icon="xmark" class="rounded-full h-5 w-5 bg-red-500 px-0.5 py-1 text-xs absolute right-0 -top-0.5" />
            </div>
